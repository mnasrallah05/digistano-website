...
export default function CTAnalyzerPage() {
  const [activeTab, setActiveTab] = useState<"description" | "attachment">(
    "description"
  );

  const highlights = [
    "Analyze current transformers with the push of a button",
    "Injects low test signals into the secondary side of the CT",
    ...
    "Determines unknown CT nameplate parameters and demagnetizes after test",
  ];
  ...
  const useCases = [
    {
      title: "Fast CT analysis",
      text: "CT Analyzer automates current transformer assessment and provides key parameters quickly with a push-button workflow.",
    },
    {
      title: "Accurate evaluation",
      text: "It evaluates CT performance according to the selected standard and displays relevant accuracy behavior under different currents and burdens.",
    },
    {
      title: "Practical field support",
      text: "It can determine unknown CT nameplate parameters and automatically demagnetizes the CT after the test for safe and efficient completion.",
    },
  ];

  const keyCapabilities = [
    "Equivalent circuit determination",
    "CT performance parameter identification",
    "Accuracy evaluation under burden",
    "Standards-based CT assessment",
    "Unknown nameplate parameter detection",
    "Automatic CT demagnetization",
  ];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-6">
              ...
              <p className="mb-6 text-xl text-slate-300">
                Analyze your current transformer with the push of a button
              </p>

              <p className="text-lg leading-8 text-slate-400">
                A dedicated solution for quick and accurate current transformer
                assessment, standards-based evaluation, and automatic
                demagnetization after testing.
              </p>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <a
                  href="/brochures/CT-Analyzer-Brochure-ENU-1.pdf"
                  target="_blank"
            ...
            <div className="lg:col-span-6">
              <div className="relative group">
                ...
                <div className="relative overflow-hidden rounded-3xl bg-white/5 p-6 shadow-2xl">
                  <img
                    src="/images/products/ct-analyzer.png"
                    alt="CT Analyzer"
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12 max-w-3xl">
            ...
            <h2 className="mb-4 text-3xl font-bold text-slate-900 md:text-4xl">
              Accurate CT assessment made simple
            </h2>
            <p className="text-lg text-slate-600">
              CT Analyzer simplifies current transformer testing by automating
              parameter identification, standards-based evaluation, and final
              demagnetization in one workflow.
            </p>
          </div>
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-slate-900">
                    CT-Analyzer-Brochure-ENU-1.pdf
                  </h2>
                </div>
