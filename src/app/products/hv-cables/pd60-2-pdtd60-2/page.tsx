...
export default function PD602PDTD602Page() {
  ...
  const highlights = [
    ...
    "PDTD60-2 includes integrated Tan Delta diagnostics",
  ...
  const featureCards = [
    {
      title: "Performance",
      text: "PDTD60-2 includes integrated Tan Delta diagnostics capabilities and thus features simultaneous comprehensive PD and TD diagnostics, saving time and avoiding preconditioning of the cable, which would lead to false results.",
    },
    {
      title: "Comprehensive diagnostics",
      text: "PDTD60-2 allows measurement of cables with different lengths at constant frequency, being a prerequisite for the comparison of PD and TD results from previous measurements.",
    },
    {
      title: "Application",
    ...
    },
    {
      ...
      text: "In combination with the HVA60 device (not in scope of supply), PDTD60-2 creates a full-featured and full-value system for 60 kV output voltage scope.",
    },
    {
      title: "Compliance",
      text: "PD60-2 and PDTD60-2 devices are in compliance with guides like IEEE 400.2 and 400.3 and standards HD 620, CEI EN 50393, IEC 60270, IEC 60502-2 and their local derivations.",
    },
  ];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-6">
              ...
              <p className="mb-6 text-xl text-slate-300">
                Advanced PD and Tan Delta diagnostics for medium and high-voltage cable systems
              </p>
              ...
              <p className="text-lg leading-8 text-slate-400">
                ...
                early detection of vulnerabilities and preventative maintenance
            ...
            <div className="lg:col-span-6">
              <div className="relative group">
                ...
                <div className="relative overflow-hidden rounded-3xl bg-white/5 p-6 shadow-2xl">
                  <img
                    src="/images/products/pd60-2-pdtd60-2.png"
                    alt="PD60-2 & PDTD60-2"
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12 max-w-3xl">
            ...
            <h2 className="mb-4 text-3xl font-bold text-slate-900 md:text-4xl">
              Comprehensive PD and Tan Delta diagnostics for cable systems
            </h2>
            <p className="text-lg text-slate-600">
              PD60-2 and PDTD60-2 support accurate defect localization,
          ...
          {activeTab === "description" ? (
              ...
              <div className="lg:col-span-8">
                <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                  ...
                  <div className="space-y-6 text-lg leading-9 text-slate-700">
                    <p>
                      The PD60-2 and PDTD60-2 offer both portable and built-in
            ...
            >
              <div className="space-y-6">
                <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between rounded-2xl border border-slate-200 p-6">
                  <div>
                    <p className="mb-2 text-sm font-semibold uppercase tracking-[0.3em] text-blue-600">
                      Attachment 1
                    </p>
                    <h2 className="text-2xl font-bold text-slate-900">
                      DHV1297_PD60-2_Datasheet_b2_EN_Rev06.pdf
                    </h2>
                  </div>

                  <a
                    href="/brochures/DHV1297_PD60-2_Datasheet_b2_EN_Rev06.pdf"
                    target="_blank"
                ...
                <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between rounded-2xl border border-slate-200 p-6">
                  <div>
                    ...
                    <h2 className="text-2xl font-bold text-slate-900">
                      DHV1318_PDTD60-2_Datasheet_b2_EN_Rev06_04-1.pdf
                    </h2>
                  </div>

                  <a
                    href="/brochures/DHV1318_PDTD60-2_Datasheet_b2_EN_Rev06_04-1.pdf"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-6 py-4 font-semibold text-white transition hover:bg-blue-700"
                  >
