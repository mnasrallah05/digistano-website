...
export default function HVA90Page() {
  ...
  const features = [
    ...
    {
      title: "Connectivity",
      text: "On site, no external PC is needed. All results can later be downloaded via USB for further investigation and easy reporting via software tool.",
    },
    {
  ...
  const specs = [
    { label: "Output voltage", value: "max. 90 kVpeak, 64 kVrms" },
    { label: "Output load", value: "1.0 μF @ 0.1 Hz @ 64 kVrms" },
    { label: "Weight", value: "127 kg / 280 lbs" },
  ];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-6">
              ...
              <p className="text-lg leading-8 text-slate-400">
                The HVA90 is a compact and portable VLF test set which
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <a
                  href="/brochures/DHV1445_HVA90_datasheet_EN_Rev00_01.pdf"
                  target="_blank"
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12 max-w-3xl">
            ...
            <h2 className="mb-4 text-3xl font-bold text-slate-900 md:text-4xl">
              High-output portable VLF testing for medium voltage cable diagnostics
            </h2>
            <p className="text-lg text-slate-600">
              HVA90 combines strong output performance, rugged safety design,
              and practical field connectivity for efficient medium voltage cable
                ...
                <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                  ...
                  <div className="space-y-6 text-lg leading-9 text-slate-700">
                    <p>
                      ...
                      none on the market, and make the b2 electronics high voltage
                      generators very desirable in all classes at all voltage levels.
                    </p>
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-slate-900">
                    DHV1445_HVA90_datasheet_EN_Rev00_01.pdf
                  </h2>
                </div>
