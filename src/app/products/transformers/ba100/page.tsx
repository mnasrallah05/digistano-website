...
export default function BA100Page() {
  ...
  const featureCards = [
    ...
    {
      title: "Compliance",
      text: "The BA100 device is in compliance with standard IEC 60156, its local derivations; ASTM D1816 – 04, ASTM D877 – 02, AS 1767.2.1 and GOST 6581 – 75.",
    },
  ];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-6">
              ...
              <p className="text-lg leading-8 text-slate-400">
                ...
                with fast performance, strong standards compliance, and
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <a
                  href="/brochures/DHV1207_BA100_Datasheet_b2_EN_Rev06-1.pdf"
                  target="_blank"
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12 max-w-3xl">
            ...
            <p className="text-lg text-slate-600">
              BA100 helps determine the condition of transformer insulating
              ...
              <div className="lg:col-span-8">
                <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                  ...
                  <div className="space-y-6 text-lg leading-9 text-slate-700">
                    <p>
                      Breakdown Analyzer test set BA100 is the smallest and
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-slate-900">
                    DHV1207_BA100_Datasheet_b2_EN_Rev06-1.pdf
                  </h2>
                </div>
