...
export default function FRANEO800Page() {
  const [activeTab, setActiveTab] = useState<"description" | "attachment">(
    "description"
  );

  const highlights = [
    "Advanced sweep frequency response analysis (SFRA) solution",
    "Developed for testing the mechanical and electrical integrity of power transformers",
    "Suitable after transportation or exposure to high fault currents",
    "Measures the electrical transfer function over a wide frequency range",
    "Helps improve transformer reliability",
    "Supports maintenance cost reduction and failure prevention",
  ];

  const useCases = [
    {
      title: "Integrity assessment",
      text: "FRANEO 800 is developed for testing the mechanical and electrical integrity of power transformers after transportation or exposure to high fault currents.",
    },
    {
      title: "SFRA analysis",
      text: "It uses the sweep frequency response analysis (SFRA) principle and measures the electrical transfer function over a wide range of frequencies.",
    },
    {
      title: "Reliability improvement",
      text: "With FRANEO 800, users can improve transformer reliability, reduce maintenance costs, and help prevent expensive failures.",
    },
  ];

  const keyCapabilities = [
    "Sweep frequency response analysis",
    "Transformer integrity testing",
    "Mechanical condition assessment",
    "Electrical transfer function measurement",
    "Post-transport inspection support",
    "Fault event condition verification",
  ];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-6">
              ...
              <p className="mb-6 text-xl text-slate-300">
                More than a test device
              </p>

              <p className="text-lg leading-8 text-slate-400">
                A professional SFRA solution for evaluating transformer
                integrity, improving reliability, reducing maintenance costs,
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <a
                  href="/brochures/FRANEO-800-Brochure-ENU-1.pdf"
                  target="_blank"
            ...
            <div className="lg:col-span-6">
              <div className="relative group">
                ...
                <div className="relative overflow-hidden rounded-3xl bg-white/5 p-6 shadow-2xl">
                  <img
                    src="/images/products/franeo-800.png"
                    alt="FRANEO 800"
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-12 max-w-3xl">
            ...
            <h2 className="mb-4 text-3xl font-bold text-slate-900 md:text-4xl">
              Transformer integrity analysis with SFRA technology
            </h2>
            <p className="text-lg text-slate-600">
              FRANEO 800 supports accurate transformer condition assessment
              after transport, high fault exposure, and other events that may
              affect mechanical or electrical integrity.
            </p>
          </div>
              ...
              <div className="lg:col-span-8">
                <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                  ...
                  <div className="space-y-6 text-lg leading-9 text-slate-700">
                    <p>
                      FRANEO 800 was developed for testing the mechanical and
                      electrical integrity of power transformers after
                      transportation or exposure to high fault currents.
                    </p>

                    <p>
                      It uses the sweep frequency response analysis (SFRA)
                      principle and measures the electrical transfer function
                      over a wide range of frequencies.
                    </p>

                    <p>
                      With our FRANEO 800 you can improve your transformer
                      reliability, reduce maintenance costs and prevent
                      expensive failures.
                    </p>
                  </div>
                </div>
